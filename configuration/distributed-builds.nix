...
in
{
  ...
  nix.sshServe.keys = [
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIF3ZvE1U1l1TtzjxFtBGwU7Dc/Mm9xuF6G9yH47Dwjbw alex800121@alexrpi4tp"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGvXFSJwUYt/dUpUIO8wuEaOKjYZBkOLqgiBlmiMSzuj root@alexrpi4tp"
  ...
  nix.settings.trusted-public-keys = [
    ...
    "nix-alexrpi4tp:7PN2SXXiPJV56A8GEToHGsUECDOqWIEA1MeNXCb0C4o="
  ];
