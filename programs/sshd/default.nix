...
in
{
  ...
  users.users."${userName}".openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFAFNtG48ftxM7DL9Tg5tgbET+vPPXG6YX3ueHwQ+m7H u0_a481@localhost"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOj36p4+UCwPXd9uiqSkEP8GnxzKWpIdyDubAMkbLd9L alex800121@oracle"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIE95IbSl9SAg3ad49wnYKFQrwquPJA+gZsL+mV3Bsrvt root@oracle"
  ];
}
