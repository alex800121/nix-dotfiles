{ self, inputs, ... }: {
  flake.nixosConfigurations.oracle = inputs.nixpkgs.lib.nixosSystem {
    modules = [
      self.nixosModules.oracle-common
  ...
  flake.nixosConfigurations.oracle2 = inputs.nixpkgs.lib.nixosSystem {
    modules = [
      self.nixosModules.oracle-common
      self.nixosModules.topo
  ...
  flake.nixosConfigurations.oracle3 = inputs.nixpkgs.lib.nixosSystem {
    modules = [
      self.nixosModules.oracle-common
      self.nixosModules.topo
  ...
  flake.nixosModules.oracle-common =
    {
      pkgs,
      config,
      lib,
    ...
    in
    {
      imports = [
        ...
        _hardware/disko/oracle.nix
        _hardware/oracle.nix
